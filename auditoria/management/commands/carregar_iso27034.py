# auditoria/management/commands/carregar_iso27034.py
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Lista de seções com perguntas (extraídas do seu questionario.js)
        SECOES = [
            {
                "titulo": "1.1 Estabelecendo o comitê do ONF",
